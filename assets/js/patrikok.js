var patrikok = [
    ...
    'Hallod, nyit egy PRt, broken a CI, nem csinálta meg amit kellene és boldogan beküldi.',
    'Ilyen sötét helyen még nem dolgoztál!',
    'Ez Tamás: immár nem kezdő manager, hanem egy kikristályosodott senior papucs',
    ...
    'Nah buzi, eljutottunk oda, hogy mindenki örül a ducttapenek, én nem.',
    'Mint mikor zöld a slackem és olyan mintha dolgoznék, közben meg hát...',
    'Ha kiváló gyapot szedő lennék, érted, aki még kortyolni sem állna meg, csak szedném és még magamat is ostoroznám közbe, akkor lenne 6% emelés, 24k havonta, kb. Ne vicceljünk már, akkor szedem lazában a gyapotot és csinálom a kis dolgaim.',
    'Opus 4.6. Olyan jó, mint még soha! Elveszi az emberek munkáját, próbáld ki! Én ansiblere akartam, hallod, a híg fos hozzá képest stabil, úgy generálja a szart, kérsz valamit és még több fost rak bele.',
    ...
    'Nem csinál semmit, csak kibaszott bot a küllők között!',
    'Sajnálom emberileg, de egy fasz.',
    'Buta, mint az éjszaka, lusta, mint Balázsbá és akkora az arca, mint Ákosnak.',
    ...
    'Ez már nem Balázsbá-i magaslatok, buzi, már rég leköröztem az öreget, mert ő bár nem dolgozott, annak meg is volt a látszata. Én úgy minimalizálom már a munkát, hogy maximalizáljam a profitot.',
];
var tutik = patrikok;
